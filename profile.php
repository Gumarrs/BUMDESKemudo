...
<head>
  ...
  <title>Profil | BUMDesa Kemudo Makmur</title>
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li class="dropdown active"><a href="profile.php"><span>Profil</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
              <li><a href="about.php" class="active">Visi Misi</a></li>
  ...
  <main id="main">
    ...
    <section id="about" class="about">
      <div class="container">
        ...
        <div class="row content">
          ...
          $result = mysqli_query($connection, "SELECT * FROM visi");
          ?>
          <div class="col-lg-6">
            <?php
        ...
        <div class="col-lg-6 pt-4 pt-lg-0">
          <?php
          $result = mysqli_query($connection, "SELECT * FROM misi");
          ?>
          <h2>MISI</h2>
          ...
          while ($data = mysqli_fetch_array($result)) :
          ?>
            <h5><?= $data['id'] ?>. <span><?= $data['misi'] ?></span></h5>
    ...
    <section id="team" class="team section-bg">
      <div class="container">
        ...
        <div class="section-title">
          ...
          <p>Susunan Pengurus BUMDesa Kemudo Makmur :</p>
        </div>
        <?php
        include "admin/helper/connection.php";
    ...
    <section id="skills" class="skills">
      <div class="container">
        ...
        <div class="section-title">
          <h2>Penghargaan</h2>
          <p>Penghargaan yang dimiliki oleh BUMDesa Kemudo Makmur :</p>
        </div>
        <?php
        $result = mysqli_query($connection, "SELECT * FROM achive");
        ?>
        <div class="row skills-content">
          ...
          <div class="col-lg-6">
            ...
            while ($data = mysqli_fetch_array($result)) :
            ?>
              <h6><?= $data['id'] ?>. <span><?= $data['achive'] ?></span></h6>
