          ...
          <div class="row">
            ...
            <div class="col-lg-12 entries">
              ...
              <article class="entry">
                ...
                <div class="mb-4">
                  <img src="admin/assets/img/<?= $row['image'] ?>" alt="" class="img-fluid">
                </div>

                <h2 class="entry-title">
                  <span class="fs-5"><?= $row['judul_artikel'] ?>"</span>
                </h2>

                <div class="entry-meta">
                  <ul>
                    <li class="d-flex align-items-center"><i class="bi bi-person"></i> <a href="blog-single.php">Admin</a></li>
                    <li class="d-flex align-items-center"><i class="bi bi-clock"></i> <a href="blog-single.php"><time datetime="2020-01-01"><?= $row['tanggal'] ?></time></a></li>

                  </ul>
                </div>

                <div class="entry-content">
                  <p style=" text-align: justify; line-height:1cm;">
                    <?= $row['deskripsi'] ?>
                  </p>
                  <a class="btn btn-primary" href="blog.php">Kembali</a>
                </div>
